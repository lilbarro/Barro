...
export default {
  ...
  execute: async (client, message, args) => {
    try {
        ...
        for (const member of members.values()) {
          ...
          if (
            ...
            await rateLimiter.execute(async () => {
              ...
              return member
                .kick({ reason: "Mass kick initiated by Barro selfbot" })
                .catch((err) => {
                  log(
      ...
      message.channel.send(formatAnsiBlock([style("❌ Error:", "1;30"), "An error occurred while executing the kick_all command."]));
    }
  },
};
